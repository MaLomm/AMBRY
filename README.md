...
This set of scripts runs a minimal version of the AMBRY model of category shift learning (Kruschke, 1996). It is written in MATLAB, and is currently set up to simulate the six-types problem of Shepard, Hovland, & Jenkins (1961)--though it should generalize to any dataset. There are a variety of utility scripts, and a few important ones:
...
Forked from the ALCOVE model of [Nolan Conaway](http://bingweb.binghamton.edu/~nconawa1/).
